...
#Description: This program takes in a file name from the user ending in ".dat" 
#             or ".txt" and reads in the grid provided. The program then uses a
#             recursive function named fillIn() that acts similar to the
#             bucket tool in an editing program (microsoft paint).
#             The user also has the option of seeing each step of the recursion
#             occur (which happens in the order of up, right, down, left). The
#             program ends when the user enters "Q" as the coordinates.
